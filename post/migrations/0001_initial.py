# Generated by Django 5.1.7 on 2025-04-28 13:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='posts_images', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])])),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'post_likes',
                'constraints': [models.UniqueConstraint(fields=('author', 'post'), name='unique_author_post_like')],
            },
        ),
    ]
